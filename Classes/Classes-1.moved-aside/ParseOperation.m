...
/*
@synthesize eventData, currentEarthquakeObject, currentParsedCharacterData, currentParseBatch;


- (id)initWithData:(NSData *)parseData
{
    if (self = [super init]) {    
		eventData = [parseData copy];
...
- (void)addEarthquakesToList:(NSArray *)earthquakes {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:kAddEventsNotif
                                                        object:self
...
- (void)main {
    ...
    self.currentParsedCharacterData = [NSMutableString string];
		...
		// connection errors.
		//
    NSXMLParser *parser = [[NSXMLParser alloc] initWithData:self.eventData];
...
- (void)parser:(NSXMLParser *)parser didStartElement:(NSString *)elementName
 ...
 qualifiedName:(NSString *)qName
	attributes:(NSDictionary *)attributeDict {
		...
		//
    if (parsedEventCounter >= kMaximumNumberOfEarthquakesToParse) {
    ...
    if ([elementName isEqualToString:kEntryElementName]) {
        ...
        self.currentEarthquakeObject = events;
        [events release];
...
- (void)handleEarthquakesError:(NSError *)parseError {
    [[NSNotificationCenter defaultCenter] postNotificationName:kEventsErrorNotif
														object:self

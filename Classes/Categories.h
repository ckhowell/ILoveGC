...
@interface Categories : UIViewController <UITableViewDelegate ,UIScrollViewDelegate, UIActionSheetDelegate, IconDownloaderDelegate>
{	
	UIButton *arts;
	UIButton *community;
	UIButton *showall;
    ...
    UIView *viewBGColored;
    UIImageView *imgMovable;
...
@property (nonatomic, retain) IBOutlet UIView *viewBGColored;
@property (nonatomic, retain) IBOutlet UIImageView *imgMovable;

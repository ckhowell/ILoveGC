...
- (void)webViewDidFinishLoad:(UIWebView *)webView {
  ...
  _spinner.hidden = YES;
	...
	[_webView stringByEvaluatingJavaScriptFromString:@"document.getElementsByName('feedform_user_message')[0].rows = 6;"];
...
- (void)show {
	...
	_titleLabel.frame = CGRectMake(
								   ...
								   _titleLabel.frame.size.height + kTitleMarginY*2 - 20);
	...
	_webView.frame = CGRectMake(
								kBorderWidth+1,
								kBorderWidth + _titleLabel.frame.size.height - 5,
								innerWidth,
